...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/app": function(exports, require, module) {(function() {
...
}, "collections/installed_app": function(exports, require, module) {(function() {
  var App, BaseCollection,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.InstalledAppCollection = (function(_super) {

    __extends(InstalledAppCollection, _super);

    InstalledAppCollection.prototype.model = App;

    InstalledAppCollection.prototype.url = '/api/installed-apps/';

    function InstalledAppCollection() {
      InstalledAppCollection.__super__.constructor.call(this);
    }

    return InstalledAppCollection;
...
}, "models/installed_app": function(exports, require, module) {(function() {
  var BaseModel,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.InstalledApp = (function(_super) {

    __extends(InstalledApp, _super);

    InstalledApp.prototype.url = '/api/installed-apps/';

    function InstalledApp(app) {
      InstalledApp.__super__.constructor.call(this);
      this.slug = app.slug;
      this.name = app.name;
      this.path = "/" + app.slug + "/";
    }
...
}, "templates/app": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push('<h1>Welcome to your cloud</h1>\n<h2>A lovely cosy place...</h2>\n\n<div id="app-list">\n  \n</div>\n\n');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/installed_app": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/app": function(exports, require, module) {(function() {
...
}, "views/installed_app": function(exports, require, module) {(function() {
  ...
  exports.InstalledAppRow = (function(_super) {

    __extends(InstalledAppRow, _super);

    InstalledAppRow.prototype.className = "installed-app";

    InstalledAppRow.prototype.events = {
      "click .button": "onRemoveClicked"
    };

    function InstalledAppRow(model) {
      this.model = model;
      this.onRemoveClicked = __bind(this.onRemoveClicked, this);
      InstalledAppRow.__super__.constructor.call(this, this.model);
    }

    InstalledAppRow.prototype.onRemoveClicked = function(event) {
      event.preventDefault();
      return this.removeApp();
    };

    InstalledAppRow.prototype.removeApp = function() {
      var _this = this;
    ...
    InstalledAppRow.prototype.render = function() {
  ...
  AppRow = require('views/app').AppRow;

  AppCollection = require('collections/app').AppCollection;
